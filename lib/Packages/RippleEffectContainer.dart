...
class ClickEffect extends StatefulWidget {
  ...
  /// ClickEffect widget background color [backgroundColor]
  ...
  /// ClickEffect widget width size [width]
  final double? width;

  /// ClickEffect widget height size [height]
  final double? height;
            ...
            Opacity(
              ...
              child: CustomPaint(
                ...
                painter: RipplePainer(
                    ...
                    fillColor: widget.rippleColor ?? MyColor.rippleColor),
              ),
            )
          ],
        ),
  ...
  void paint(Canvas canvas, Size size) {
    ...
    var paint = Paint()
      ..color = this.fillColor == null
          ? throw Exception("rippleColor of ClickEffect == null")
          : this.fillColor!
      ..isAntiAlias = true;
